INSERT INTO users (user_id, name, description, roles, password_hash, date_created, date_updated) VALUES
	('5cf37266-3473-4006-984f-9325122678b7', 'Admin Gopher', 'This is the admin user', '{ADMIN,USER}', '$2a$10$1ggfMVZV6Js0ybvJufLRUOWHS5f6KneuP0XwwHpJ8L8ipdry9f2/a', '2019-01-24 00:00:00', '2019-01-24 00:00:00'),
	('45b5fbd3-755f-4379-8f07-a58d4a30fa2f', 'User Gopher', 'This is some regular user', '{USER}', '$2a$10$9/XASPKBbJKVfCAZKDH.UuhsuALDr5vVm6VrYA9VFR8rccK86C1hW', '2019-03-24 00:00:00', '2019-03-24 00:00:00'),
	('d29b4b23-c003-4519-b3af-051b9c9b3c5a', 'SMA BNBUSDT 1H', 'This strategy triggers when the price crosses above or below a moving average signalising a potential change in trend. It uses two moving averages to find trend and opportunity.', '{USER}', '$2a$10$9/XASPKBbJKVfCAZKDH.UuhsuALDr5vVm6VrYA9VFR8rccK86C1hW', '2019-03-25 00:00:00', '2019-03-24 00:00:00'),
	('5af36f98-b5d2-4991-b2ba-95442550897b', 'SMA BNBUSDT 4H', 'This strategy triggers when the price crosses above or below a moving average signalising a potential change in trend. It uses two moving averages to find trend and opportunity.', '{USER}', '$2a$10$9/XASPKBbJKVfCAZKDH.UuhsuALDr5vVm6VrYA9VFR8rccK86C1hW', '2019-03-26 00:00:00', '2019-03-24 00:00:00')
