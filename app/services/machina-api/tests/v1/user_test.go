...
func (ut *UserTests) getToken404(t *testing.T) {
	...
	r.SetBasicAuth("c82c749c-6fd5-40b7-82f5-b6c7f661c8a0", "some-password")
	ut.app.ServeHTTP(w, r)

	t.Log("Given the need to deny tokens to unknown users.")
	{
		testID := 0
		t.Logf("\tTest %d:\tWhen fetching a token with an unrecognized UUID.", testID)
		{
...
func (ut *UserTests) getToken200(t *testing.T) {
	...
	r.SetBasicAuth("5cf37266-3473-4006-984f-9325122678b7", "gophers")
	ut.app.ServeHTTP(w, r)
